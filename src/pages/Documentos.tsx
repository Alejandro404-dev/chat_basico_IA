...
export default function Documentos() {
  ...
  const limpiarTodo = useDocumentosStore((state) => state.limpiarTodo)
  ...
  //Guardamos el nuevo titulo, mientras que el usuario escribe en el input
  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-white p-6 " >
      <div className="mb-4" >
        <Link
          to="/" className="text-sm bg-zinc-800 hover:bg-zinc-600 px-3 py-1 rounded "
        >
          Volver al chat
        </Link>
      ...
      {documentos.length === 0 ?
        ...
        (<p className="text-gray-400" >no hay documentos guardaos todavia</p>)
        :
        (
